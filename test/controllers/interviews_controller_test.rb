...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { company_name: @interview.company_name, date: @interview.date, method: @interview.method, stage: @interview.stage, verdict: @interview.verdict } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { company_name: @interview.company_name, date: @interview.date, method: @interview.method, stage: @interview.stage, verdict: @interview.verdict } }
