...
class InterviewsTest < ApplicationSystemTestCase
  ...
  test "creating a Interview" do
    ...
    fill_in "Company name", with: @interview.company_name
    fill_in "Date", with: @interview.date
    fill_in "Method", with: @interview.method
    fill_in "Stage", with: @interview.stage
    fill_in "Verdict", with: @interview.verdict
